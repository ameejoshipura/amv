...
public class addThreeVectors extends ActionBarActivity {
    ...
    public void addThreeVC(View view){
        ...
        editText = (EditText)findViewById(R.id.X3Input);
        double x3 = Double.parseDouble(editText.getText().toString());
        ...
        editText = (EditText)findViewById(R.id.Y3Input);
        double y3 = Double.parseDouble(editText.getText().toString());
